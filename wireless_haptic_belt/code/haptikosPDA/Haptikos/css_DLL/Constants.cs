...
namespace HapticDriver
{
    ...
    internal static class Constants
    {
        ...
        public const ushort uint16_t_max = 65535;
        public const ushort PERIOD_MAX = 2000; //2000 microseconds (2 millisec)
        public const ushort DUTY_CYCLE_MIN = 2; //2 microseconds
    }
}