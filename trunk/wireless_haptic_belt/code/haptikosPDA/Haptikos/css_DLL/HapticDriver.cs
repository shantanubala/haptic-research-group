...
namespace HapticDriver
{
    ...
    public partial class HapticBelt
    {
        ...
        /// default is 600 milliseconds for Windows Mobile on ARM9 processor,
        /// which might need to be increased
        /// for long wireless transmission distances (up to 100m outdoors).
        /// </summary>
        public static int MAX_RESPONSE_TIMEOUT = 600; // milliseconds
        ...
        public error_t OpenPorts() {
            ...
            if (port_setup) {
                ...
                //
                // Causes issues with Windows Mobile
                //byte[] test = { 0x0A }; // == '\n'                
