 ...
 *         
 * DESCR:  Contains all functions related to haptic belt magnitude
...
namespace HapticDriver
{
    public partial class HapticBelt
    {
        ...
        public error_t Learn_Magnitude(string mag_id, ushort period, ushort duty_cycle) {
        ...
        public error_t Learn_Magnitude(string mag_id, int percentage) {
            ...
            ushort period, duty_cycle, percent;
            error_t return_error = error_t.EINVM;
